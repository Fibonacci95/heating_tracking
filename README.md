...
The corresponiding time values were then sent via MQTT to a raspberry PI that was acting as a MQTT broker and further also collecting the time values.

## Project overview
The time values were collected under /evaluate/data/timestamps.txt. Once the script 
